...
var PostFeed = document.createElement('style'); var NavBar = document.createElement('style');
El.type = SearchBar.type = NotifyMenu.type = UploadWindow.type = IdleWindow.type = NavBar.type = PostFeed.type = 'text/css';

var url = window.location.href; var urlProfile = url.substring(0,18); var urlSettings = url.substring(0,25); var urlGAG = url.substring(0,20);
//var urlGAG = url.substring(0,20);
//var urlGAG = url.substring(0,20);
//window.alert(urlProfile);
