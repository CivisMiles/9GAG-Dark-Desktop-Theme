...
var a = document.createElement('style');
*/
El.type = SearchBar.type = NotifyMenu.type = UploadWindow.type = ProfilePage.type = SettingsPages.type = SideBar.type = BannerPostFeed.type = 'text/css';
...
/*
  Part   ---   Description/What it effects   ----------------------------------------------------------------   Current text within "styleE1.innerHTML"   ----------------------------------------------------------------   Extra Notes
    ...
    8   ----   Navigation bar background and bottom border colors  ------------------------------------------   .section-nav { background-color: #101010; border-bottom: 1px solid #999;}   ------------------------------   N/A
    9   ----   Navigation bar unselected option textcolor   -------------------------------------------------   .section-nav a { color: #999;}   -------------------------------------------------------------------------   N/A
    10   ---   Navigation bar selected option textcolor   ---------------------------------------------------   .section-nav a.selected { background-color: rgba(255,255,255,.2); color: #101010;}   ---------------------   N/A
